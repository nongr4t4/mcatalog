...
<label <?php echo e($attributes->merge(['class' => 'block font-medium text-sm text-ui-muted'])); ?>>
    <?php echo e($value ?? $slot); ?>

</label>
<?php /**PATH /var/www/html/resources/views/components/input-label.blade.php ENDPATH**/ ?>